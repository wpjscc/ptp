 ...
 */
final class AsyncThroughStream extends EventEmitter implements DuplexStreamInterface,\Wpjscc\PTP\Log\LogManagerInterface
{
    ...
    public function write($data)
    {
        ...
        if ($this->callback !== null) {
            try {
                $data = \call_user_func($this->callback, $data, $this);
            } catch (\Exception $e) {
            ...
            if ($data instanceof Promise) {
                $data->then(function ($size) {
                    static::getLogger()->debug("AsyncThroughStream write promise", [
                        'class' => __CLASS__,
                        'size' => $size,
                    ]);
                }, function ($error) {
                    static::getLogger()->error("AsyncThroughStream write promise error", [
                        'class' => __CLASS__,
                        'error' => $error,
                    ]);
